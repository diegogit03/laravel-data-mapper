...
If you discover a security vulnerability in Eloquent Data Mapper, please report it privately using one of the following channels:
...
2. **Email** — send the details to Diego Henrique at **dhom91718@gmail.com**.
